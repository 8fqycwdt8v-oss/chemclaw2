...
// assertElnHostNotPrivate and fetch's own DNS lookup. The request carries
// the ELN bearer token, so the IP that connects MUST be the IP that passed.
function safeLookup(
  hostname: string,
...
const ELN_DISPATCHER = new Agent({
