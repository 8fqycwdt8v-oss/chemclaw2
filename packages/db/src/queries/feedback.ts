 ...
 * (project_key = chemclaw2:<userId>, session_id, subpath); returns true
 * if at least one row matches. Used to gate feedback writes — without it
 * any signed-in user could attach feedback rows to any sessionId.
 */
