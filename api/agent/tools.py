...
from api.agent.tools_external import register_external_tools
from api.agent.tools_investigation import register_investigation_tools
...
def build_chemclaw_mcp_server(
    ...
    register_investigation_tools(mcp, user_id, session_id, session_factory)
    register_external_tools(mcp, user_id, session_factory)
